...
## 🚀 Core Expertise & Ecosystem

<table>
  <tr>
    <td valign="top" width="50%">
      <h4>🌐 Backend & Distributed Infrastructure</h4>
  ...
  <tr>
    <td valign="top" width="50%">
      <h4>🛠️ DevOps, Systems & Architecture</h4>
      <p>
      ...
      <ul>
        <li><b>System Administration:</b> Bare-metal server provisioning, advanced custom driver configuration, and robust process automation via shell scripting.</li>
        <li><b>Cloud & CI/CD:</b> Containerizing microservices and building automated testing/deployment pipelines using GitHub Actions to guarantee high availability.</li>
        <li><b>System Hardening:</b> Configuring reverse proxies (Nginx), managing firewall rules, and optimizing Linux kernel parameters for production-grade security.</li>
      </ul>
    </td>
    <td valign="top" width="50%">
